 ...
 * @{
 */
#ifndef _CHECKING_ACCOUNTV6_H_
#define _CHECKING_ACCOUNTV6_H_

#include "Accountv6.h"

class Checking_Accountv6: public Accountv6 {
private:
    static constexpr double default_fee = 1.50;
public:
    Checking_Accountv6(std::string name, double balance);
    virtual ~Checking_Accountv6();
