 ...
 * @{
 */
#ifndef _SAVINGS_ACCOUNTV1_H_
#define _SAVINGS_ACCOUNTV1_H_

#include "Accountv1.h"
class Savings_Accountv1: public Accountv1 {
    friend std::ostream &operator<<(std::ostream &out, const Savings_Accountv1 &source);
private:
...
public:
    Savings_Accountv1(std::string name = default_name, 
