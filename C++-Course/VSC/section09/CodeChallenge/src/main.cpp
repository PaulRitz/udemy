/**
 * @file main.cpp
 * @brief a program to learn to edit arrays/vectors and use its content and use c++ operators
 * @details This challenge is about using a collectin (list) of integers and allowing the user 
...
/**
 * @defgroup section09 Section 09: Controlling Program Flow
 * @brief in this section is shown how to control the program flow with control structures
 * @details the shown control structures are the if statement, the (do) while loop, the for loop, 
 * the switch case statement and other conditional operators 
 */

/**
 * @addtogroup section09
 * @{
 * @defgroup s09_cc CodeChallenge
 * @brief a program to learn to edit arrays/vectors and use its content and use c++ operators
 * @details This challenge is about using a collectin (list) of integers and allowing the user 
 * to select options from a menu to perform operations on the list.
 * 
